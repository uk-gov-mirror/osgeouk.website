...
Conference t-shirts are an optional extra which can also be selected through the registration form. We will be using [spreadshirt](https://www.spreadshirt.co.uk/) to print t-shirts prior to the conference in October. You are more than welcome to print your own shirt using the SVG logo below. We are offering the service to print shirts in order to save on delivery and printing costs. Please see these size guides for the men's and women's t-shirt.

<img src="../assets/images/tshirt_size_guide.png" style="max-height:400px; margin: auto; display: block;">

<img src="../assets/images/foss4g_uk_owl_green.svg" style="max-height:100px; margin: auto; display: block;">
